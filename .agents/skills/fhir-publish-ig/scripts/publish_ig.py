...
SELF_HOSTED_LABEL_SETS = (
    ("self-hosted", "Linux", "X64", "docker", "atlas", "fhir-publisher"),
    ("self-hosted", "Linux", "X64", "docker", "atlas-2", "fhir-publisher"),
)
TAIL_LIMIT = 4000
    ...
    return envelope(
        ...
        next_steps=[
            (
                ...
                f"python3 skills/fhir-publish-ig/scripts/publish_ig.py publish "
...
def publish(args: argparse.Namespace) -> dict[str, Any]:
    ...
    next_steps = [
        (
            ...
            f"python3 skills/fhir-publish-ig/scripts/publish_ig.py watch "
