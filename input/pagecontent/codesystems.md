...
### ProposalContributionRoleCS — Proposal Contribution Role

Roles that describe how an agent contributed to a structured clinical proposal lifecycle.
...
| `linked-existing` | Linked to existing record | A proposal was resolved by linking to an existing clinical record instead of creating a duplicate. |
