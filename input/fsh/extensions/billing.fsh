...
Title: "Ausschlüsse"
Description: "Ausgeschlossene EBM-Gebührenordnungspositionen (wiederholbar — je ein Coding pro ausgeschlossener GOP)"
Context: ChargeItemDefinition
* value[x] only Coding
* valueCoding from EbmGopVS (example)

Extension: BillingExclusionsContextExt
Id: billing-exclusions-context
Title: "Ausschlüsse mit Bezugsraum"
Description: "Ausschlussregelungen mit zeitlichem Bezugsraum-Kontext (wiederholbar je Bezugsraum-Gruppe). Enthält bezugsraum (BF/AF/SF/TG) und eine Liste ausgeschlossener GOP-Codings."
Context: ChargeItemDefinition
* extension contains
    bezugsraum 1..1 and
    excludedGop 1..*
* extension[bezugsraum].value[x] only code
* extension[bezugsraum].valueCode from BillingBezugsraumVS (required)
* extension[excludedGop].value[x] only Coding
* extension[excludedGop].valueCoding from EbmGopVS (example)
...
// ============================================================================
// Private Billing Routing (on Coverage)
// ============================================================================

Extension: BillingAssignmentExt
Id: billing-assignment
Title: "Forderungsabtretung an Billing Service"
Description: "Organization (PVS/Billing Service), an die Forderungen aus diesem konkreten Coverage-Verhaeltnis abgetreten werden."
Context: Coverage
