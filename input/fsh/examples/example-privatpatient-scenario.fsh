...
Instance: ExamplePvsOrganization
InstanceOf: Organization
Title: "PVS Rhein-Main GmbH"
Description: "Privataerztliche Verrechnungsstelle als externer Forderungserwerber fuer privat abzurechnende Leistungen."
Usage: #example
* active = true
...
* type[0].coding[+].system = "https://fhir.cognovis.de/praxis/CodeSystem/pvs-organization-type"
* type[0].coding[=].code = #pvs
* type[0].coding[=].display = "PVS"
* type[0].text = "Privataerztliche Verrechnungsstelle"
* telecom[0].system = #phone
* telecom[0].value = "+49 611 123456-0"
* address[0].line[0] = "Bahnhofstrasse 12"
* address[0].city = "Wiesbaden"
* address[0].postalCode = "65185"
* address[0].country = "DE"

Instance: ExampleCoveragePrivat
InstanceOf: FPDECoveragePrivat
Title: "PKV Debeka — Weber"
Description: "Privatkrankenversicherung des Patienten Weber bei der Debeka mit Coverage-basierter Fremdabrechnung ueber eine PVS."
Usage: #example
* status = #active
...
* extension[+].url = "https://fhir.cognovis.de/praxis/StructureDefinition/billing-assignment"
* extension[=].valueReference = Reference(ExamplePvsOrganization)

Instance: ExampleConsentBillingAssignment
InstanceOf: Consent
Title: "Einwilligung Fremdabrechnung Weber"
Description: "Einwilligung fuer die Coverage-spezifische Weitergabe an eine PVS mit HPAYMT-Zweckbindung."
Usage: #example
* status = #active
...
* provision.purpose[0] = http://terminology.hl7.org/CodeSystem/v3-ActReason#HPAYMT "healthcare payment"
* provision.actor[0].role = http://terminology.hl7.org/CodeSystem/v3-ParticipationType#IRCP "information recipient"
* provision.actor[0].reference = Reference(ExamplePvsOrganization)
* provision.data[0].meaning = #related
* provision.data[0].reference = Reference(ExampleCoveragePrivat)
...
* payee.type = http://terminology.hl7.org/CodeSystem/payeetype#other "Other"
* payee.party = Reference(ExamplePvsOrganization)
