// Szenario: Praxis-Konfiguration — RLV, Zeitbudget, WB-Zuordnung, Genehmigungen, KV-Benchmark
...
* extension[+].url = "https://fhir.cognovis.de/praxis/StructureDefinition/wb-abrechnender-arzt"
...
* extension[=].valueString = "mira-gibitzenhof"
...
* extension[+].url = "https://fhir.cognovis.de/praxis/StructureDefinition/hvg-kennung"
