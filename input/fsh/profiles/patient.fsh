...
* name.family.extension contains
    http://hl7.org/fhir/StructureDefinition/humanname-own-name|5.3.0 named eigenname 0..1 MS
* address.extension contains
    http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-precinct|5.3.0 named stadtteil 0..1 MS
