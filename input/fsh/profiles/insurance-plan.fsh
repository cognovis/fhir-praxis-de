...
* plan[gkv].type = http://fhir.cognovis.de/praxis/CodeSystem/InsurancePlanType#gkv
* plan[gkv].type MS

// PKV slice: GOÄ-Faktoren, Erstattungsregeln
* plan[pkv].type = http://fhir.cognovis.de/praxis/CodeSystem/InsurancePlanType#pkv
* plan[pkv].type MS
