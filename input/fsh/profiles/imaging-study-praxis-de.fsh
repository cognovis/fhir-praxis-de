...
* identifier[accessionNumber].system 1..1 MS
...
* identifier[accessionNumber] ^definition = "Zugriffsnummer der Studie (DICOM AccessionNumber, Tag 0008,0050). Entspricht dem identifier[accession] auf dem zugrundeliegenden ImagingServiceRequest. system pinned to pvs-id NamingSystem (PVS issues AccessionNumber on order entry, RIS reuses it for studies)."
