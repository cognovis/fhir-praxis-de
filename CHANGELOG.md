...
- **fpde-cpw.5**: Document 3-layer billing architecture: Terminology ConceptMaps (suggestions) → Catalog ChargeItemDefinitions → PLATFORM Rule-Engine business logic
